...
export default function Sidebar({ onClose, isMobile }) {
  ...
  const navItems = isResident
    ? [
        { name: 'My Home', path: '/dashboard', icon: Home },
  ...
  return (
    <aside
      style={{
        ...
        background: isResident
          ...
          : '#ffffff',
        borderRight: isResident ? '1px solid #ccfbf1' : '1px solid #e2e8f0',
        height: '100vh',
        display: 'flex',
        ...
        boxShadow: isResident
          ? '4px 0 20px rgba(45,212,191,0.08)'
    ...
    >
      ...
      <div style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
          <div
            style={{
              ...
              background: isResident
                ...
                : 'linear-gradient(135deg, #ffd369 0%, #faab36 100%)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              boxShadow: isResident
                ? '0 8px 20px rgba(45,212,191,0.35)'
                : '0 8px 20px rgba(255,211,105,0.4)',
              flexShrink: 0,
            }}
          >
            {isResident
          ...
          <div>
            ...
            <div style={{
              fontSize: '0.7rem',
              color: isResident ? '#0d9488' : '#d97706',
              fontWeight: '800',
              textTransform: 'uppercase',
              letterSpacing: '0.12em',
            }}>
              {isResident ? 'RESIDENT PORTAL' : 'LUXURY RESIDENCE'}
            </div>
          </div>
        </div>
        ...
        {isMobile && (
          <button
            onClick={onClose}
            style={{
              background: isResident ? '#f0fdf9' : '#f1f5f9',
              border: isResident ? '1px solid #ccfbf1' : '1px solid #cbd5e1',
              color: '#475569',
              padding: '0.4rem',
              borderRadius: '8px',
              display: 'flex',
      ...
      {isResident && (
        <div style={{
          background: 'linear-gradient(135deg, rgba(45,212,191,0.15) 0%, rgba(13,148,136,0.08) 100%)',
          ...
          <div>
            <div style={{ fontWeight: '700', fontSize: '0.85rem', color: '#134e4a' }}>
              {user?.name || 'Resident'}
            </div>
      ...
      <div style={{
        fontSize: '0.7rem',
        color: isResident ? '#0d9488' : '#64748b',
        fontWeight: '800',
        textTransform: 'uppercase',
        letterSpacing: '0.12em',
        ...
        {isResident ? '🏡 My Space' : 'Executive Controls'}
      </div>
          ...
          return (
            <NavLink
              ...
              style={({ isActive }) => ({
                ...
                borderRadius: '12px',
                color: isActive
                  ? (isResident ? '#134e4a' : '#78350f')
                  : '#475569',
                background: isActive
                  ? (isResident
                      ? 'linear-gradient(90deg, rgba(45,212,191,0.25) 0%, rgba(45,212,191,0.06) 100%)'
                      : 'linear-gradient(90deg, rgba(255,211,105,0.4) 0%, rgba(255,211,105,0.1) 100%)')
                  : 'transparent',
                borderLeft: isActive
                  ? `4px solid ${isResident ? '#14b8a6' : '#f59e0b'}`
                  : '4px solid transparent',
                border: isActive
                  ? `1px solid ${isResident ? 'rgba(45,212,191,0.3)' : 'rgba(245,158,11,0.3)'}`
                  : '1px solid transparent',
                boxShadow: isActive
                  ? (isResident
                      ? '0 4px 12px rgba(45,212,191,0.15)'
                      : '0 4px 12px rgba(255,211,105,0.18)')
                  : 'none',
      ...
      <div style={{ borderTop: `1px solid ${isResident ? '#ccfbf1' : '#e2e8f0'}`, paddingTop: '1.25rem', marginTop: 'auto' }}>
        {/* Owner profile card (resident has banner at top) */}
        {!isResident && (
          <div style={{
            display: 'flex', alignItems: 'center', gap: '0.75rem',
            marginBottom: '0.85rem', padding: '0.65rem', borderRadius: '10px',
            ...
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontWeight: '800', color: '#060913', flexShrink: 0,
              fontSize: '1.05rem', boxShadow: '0 4px 12px rgba(255,211,105,0.4)',
            }}>
